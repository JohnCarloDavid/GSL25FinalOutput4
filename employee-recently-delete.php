...
<body>
    ...
    <div class="mainContent">
        <a href="employee-orders.php" class="backButton"><i class="fa fa-arrow-left"></i> Back to Orders</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="employee-recently-delete.php?restore_id=<?= $row['order_id']; ?>" class="button">Restore</a>
                            <a href="employee-recently-delete.php?delete_id=<?= $row['order_id']; ?>" 
                               class="button" 
